package com.gnardini.marketoffers.zxing;
...
public class IntentIntegrator {
     ...
     *         {@link #startActivityForResult(Intent, int)} will be called on the {@link Fragment}
     *         instead
     *         of an {@link Activity}
     */
    ...
    /**
     * Initiates a scan, using the default camera, only for a certain set of barcode types, given as
    ...
    /**
     * Initiates a scan, using the specified camera, only for a certain set of barcode types, given
     * as strings corresponding
     * to their names in ZXing's {@code BarcodeFormat} class like "UPC_A". You can supply constants
     * like {@link #PRODUCT_CODE_TYPES} for example.
     *
     * @param desiredBarcodeFormats
     ...
     *         the text string to encode as a barcode
     * @param type
     *         type of data to encode. See {@code com.google.zxing.client.android.Contents.Type}
     *         constants.
     * @return the {@link AlertDialog} that was shown to the user prompting them to download the app
     * if a prompt was needed, or null otherwise
     */
